...
model = pickle.load(open(r'C:\Users\LENOVO\PycharmProjects/crop recommendation/model/model.pkl', 'rb'))
standard_scaler = pickle.load(open(r'C:\Users\LENOVO\PycharmProjects/crop recommendation/model/standscaler.pkl', 'rb'))
minmax_scaler =  pickle.load(open(r'C:\Users\LENOVO\PycharmProjects/crop recommendation/model/minmaxscaler.pkl', 'rb'))
